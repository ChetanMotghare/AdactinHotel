...
public class DriverScript {
	...
	ExtentTest test;
	String inputpath = "D:\\OJTSelenium\\Adactin\\TestInputData\\HybridTest.xlsx";
	String outputpath = "D:\\OJTSelenium\\Adactin\\TestOutputData\\HybridTestResult.xlsx";
		...
		for(int i=1; i<=xl.rowCount("MasterTestCases");i++)
		{
			...
			if(xl.getCellData("MasterTestCases", i, 2).equalsIgnoreCase("Y"))
			{
				...
				}catch(Exception e)
				{
					...
					ModuleStatus="False";
					/*File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputMode.FILE);
